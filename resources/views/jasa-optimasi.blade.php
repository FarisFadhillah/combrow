<x-base>
    <section class="container mx-auto pt-24 mb-12 flex flex-col justify-center items-center">
        ...
        <p class="w-3/4 lg:w-1/2 my-2 text-md lg:text-xl leading-tight text-white text-justify">
          <span class="font-semibold">Jasa Pengelolaan Marketplace</span> - Marketplace saat ini menjadi salah satu tempat belanja online terbesar di Indonesia.
        </p>
        <p class="w-3/4 lg:w-1/2 my-2 text-md lg:text-xl leading-tight text-white text-justify">
          Menurut Sirclo.com, jumlah pengguna marketplace di Indonesia di tahun 2020 mencapai 84,9 juta. Sebuah angka yang potensial untuk dijadikan sebagai target pasar.
        </p>
    </section>
    ...
    <section class="container mx-auto max-w-4xl py-6 mb-12 flex flex-col justify-center items-center">
      <h2 class="w-5/6 my-2 text-3xl md:text-5xl font-bold leading-tight text-center text-white">
        Menggunakan Jasa Pengelolaan Marketplace Combrow Creative
      </h2>
      ...
      <p class="mx-auto w-5/6 my-2 text-lg md:text-xl leading-tight text-justify text-white">
        Saatnya memiliki toko online yang teroptimasi dengan mudah dengan menggunakan jasa pengelolaan marketplace di Combrow Creative.
      </p>
      <p class="mx-auto w-5/6 my-2 text-lg md:text-xl leading-tight text-justify text-white">
        Agar jangkauan pasar produk Anda semakin luas dan peluang peningkatan penjualan juga akan semakin tinggi.
      </p>
    </section>

    {{-- Pricing --}}
    <section class="bg-white lg:py-8">
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
          <h2 class="w-full my-2 text-3xl lg:text-5xl font-bold leading-tight text-center text-gray-800">
            Harga Jasa Pengelolaan Marketplace
          </h2>
          <div class="flex justify-center items-center">
            <p class="w-5/6 my-2 text-lg lg:text-xl leading-tight text-center text-gray-800">
              Berapa harga jasa pengelolaan marketplace yang kami tawarkan?
            </p>
          </div>
          <div class="flex flex-col sm:flex-row justify-center pt-4 lg:my-8 sm:my-4">
            <div class="flex flex-col lg:pr-8 w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg mt-4">
              <div class="bg-[#88a8fa] text-white rounded-xl overflow-hidden shadow-2xl">
                ...
                <ul class="w-full text-center text-sm">
                  <li class="border-b py-2">Upload Produk sehari 1 produk dengan Judul tertarget, foto yang sudah di design, deskripsi, dan hashtag</li>
                  <li class="border-b py-2">Optimasi Followers Marketplace</li>
                  <li class="border-b py-2">Dekorasi toko (banner, etalase, paket diskon, dll)</li>
                  <li class="border-b py-2">Marketplace yang digunakan adalah Shopee dan Tokopedia</li>
                </ul>
                <div class="flex items-center justify-center">
                  <a href="https://api.whatsapp.com/send?phone=62858639537275&text=Saya%20tertarik%20jasa%20pengelolaan%20marketplace%20basic" class="mx-auto lg:mx-0 hover:underline bg-white text-[#88a8fa] font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Order Paket Basic
                  </a>
                </div>
              </div>
            ...
            <div class="flex flex-col lg:pr-8 w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg mt-4">
              <div class="bg-[#88a8fa] text-white rounded-xl overflow-hidden shadow-2xl">
                ...
                <ul class="w-full text-center text-sm">
                  <li class="border-b py-2">Upload Produk sehari 2 produk dengan Judul tertarget, foto yang sudah di design, deskripsi, dan hashtag</li>
                  <li class="border-b py-2">Optimasi Followers Marketplace</li>
                  <li class="border-b py-2">Dekorasi toko (banner, etalase, paket diskon, dll)</li>
                  <li class="border-b py-2">Marketplace yang digunakan adalah Shopee dan Tokopedia</li>
                </ul>
                <div class="flex items-center justify-center">
                  <a href="https://api.whatsapp.com/send?phone=62858639537275&text=Saya%20tertarik%20jasa%20pengelolaan%20marketplace%20silver" class="mx-auto lg:mx-0 hover:underline bg-white text-[#88a8fa] font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Order Paket Silver
                  </a>
                </div>
              </div>
            ...
            <div class="flex flex-col lg:pr-8 w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg mt-4">
              <div class="bg-[#88a8fa] text-white rounded-xl overflow-hidden shadow-xl">
                ...
                <ul class="w-full text-center text-sm">
                  <li class="border-b py-2">Upload Produk sehari 4 produk dengan Judul tertarget, foto yang sudah di design, deskripsi, dan hashtag</li>
                  <li class="border-b py-2">Optimasi Followers Marketplace</li>
                  <li class="border-b py-2">Dekorasi toko (banner, etalase, paket diskon, dll)</li>
                  <li class="border-b py-2">Setting Marketplace Ads (budget iklan diluar harga paket)</li>
                  <li class="border-b py-2">Marketplace yang digunakan adalah Shopee dan Tokopedia</li>
                </ul>
                <div class="flex items-center justify-center">
                  <a href="https://api.whatsapp.com/send?phone=62858639537275&text=Saya%20tertarik%20jasa%20pengelolaan%20marketplace%20gold" class="mx-auto lg:mx-0 hover:underline bg-white text-[#88a8fa] font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Order Paket Gold
                  </a>
                </div>
              </div>
