            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-xl md:text-4xl text-gray-800 font-bold leading-none mb-8">
                        Alasan Pentingnya Memiliki Website
                    </h3>
                    <p class="text-gray-600 mb-8 text-md md:text-xl ">
                        Memiliki website adalah langkah penting di era digital ini. Website memungkinkan Anda menjangkau pelanggan di seluruh dunia dan memberikan informasi penting tentang produk atau layanan Anda. Selain itu, website meningkatkan kredibilitas dan profesionalisme bisnis Anda.
                    </p>
                    <p class="text-gray-600 mb-8 text-md md:text-xl ">
                        Website juga memfasilitasi interaksi yang lebih baik dengan pelanggan melalui fitur seperti formulir kontak, blog, dan media sosial. Ini dapat meningkatkan kepuasan dan loyalitas pelanggan. Selain itu, website memungkinkan strategi pemasaran digital seperti SEO dan iklan online.
                    </p>
                    <p class="text-gray-600 mb-8 text-md md:text-xl ">
                        Dengan website, Anda dapat meningkatkan visibilitas dan pertumbuhan bisnis. Memiliki website adalah investasi yang penting untuk tetap kompetitif dan relevan di pasar modern.
                    </p>
                </div>
                <div class="w-full sm:w-1/2 p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-full sm:h-116 mx-auto" viewBox="0 0 641.51274 626.39159" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g>
                        <path
                        ...
                        <circle cx="485.60718" cy="174.40329" r="65" fill="#ff6884" />
                        <path
          ...
          <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-2xl overflow-hidden flex flex-col justify-center items-center shadow-2xl">
                ...
                <div class="w-full mb-4 text-xl text-center text-slate-600 px-6">
                    Website adalah penghubung yang efektif antara usaha kita dengan konsumen/pelanggan. Karena mudah ditemukan melalui internet.
                </div>
            </div>
          </div>
          <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-2xl overflow-hidden flex flex-col justify-center items-center shadow-2xl">
                <div class="w-full mt-4 mb-2 font-bold text-2xl text-center text-slate-700 px-6">
                    Media Promosi Ke Pelanggan
                </div>
                <div class="w-full mb-4 text-xl text-center text-slate-600 px-6">
                    Program-program pemasaran dan keunggulan perusahaan bisa disampaikan ke konsumen selama 24 jam melalui website.
                </div>
            </div>
          </div>
          <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
